            ...
            <li key={li.title} className="relative ">
              <div className=" card  items-center bg-secondary  ">
                ...
                <figure className="mask mask-circle  bg-base-100">
                  <img
                    src="/images/icon_flow_01.png"
                    alt="Shoes"
                    className=" "
                  />
                </figure>
                <div className="card-body items-center">
                  <h2 className="card-title">{li.title}</h2>
                  <p>{li.description}</p>
              ...
              {li.icon?.lg && (
                <li.icon.lg
                  className={` absolute top-32 left-72 z-50 hidden lg:block text-accent `}
                  size={50}
                  stroke={5}
              ...
              {li.icon?.sp && (
                <li.icon.sp
                  className={` mx-auto -translate-y-4 lg:hidden text-accent  `}
                  size={50}
                  stroke={5}
